...
(() => {
  ...
  ready(() => {
    ...
    footer.innerHTML = `<span><b>منصة العلاقات العامة والحكومية</b> — <span id="govFooterVersion">الإصدار ${VERSION}</span></span><span class="gov-classification">الاستخدام الداخلي المصرح به فقط</span><span>الخصوصية والأمن مسؤولية مشتركة</span>`;
    document.body.appendChild(footer);
    // ملاحظة: النص أعلاه يُحدَّث تلقائيًا لاحقًا برقم الإصدار الفعلي عبر assets/core-updater.js
    // (المصدر الموحّد الوحيد لرقم الإصدار عبر كل صفحات المنصة)، فلا حاجة لجلبه هنا مرة أخرى.
  });
})();

/* ملاحظة: منطق فحص التحديث السحابي (v24-updater.js سابقًا) استُبدل بالكامل بملف
   assets/core-updater.js الموحّد — يعمل الآن على الصفحة الرئيسية وكل الأنظمة الثمانية
   معًا بدل الاعتماد على رقم إصدار ثابت داخل الكود كان يحتاج تحديثًا يدويًا كل إصدار. */