const CACHE='scc-platform-v25-1-20260724-1';
const SHELL=['./','./index.html','./manifest.webmanifest','./version.json','./assets/security-hardening.js','./assets/v21-global.css','./assets/v23-government-enterprise.css','./assets/v24-updater.css','./assets/v24-updater.js','./assets/v25-shared.css','./assets/v25-shared.js','./assets/team/fares_alharbi_v24.jpg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
