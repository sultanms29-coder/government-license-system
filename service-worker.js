const CACHE='scc-platform-v25-20260723-1';
const SHELL=['./','./index.html','./manifest.webmanifest','./version.json','./assets/security-hardening.js','./assets/v21-global.css','./assets/v23-government-enterprise.css','./assets/v25-updater.css','./assets/v25-updater.js','./assets/team/fares_alharbi_v25.jpg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
